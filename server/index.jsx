...
db.serialize(() => {
	db.run(
		"CREATE TABLE IF NOT EXIST rooms (id INTEGER PRIMARY KEY, title TEXT, description TEXT, image, TEXT)"
	);

	db.run(
		"CREATE TABLE IF NOT EXISTS messages (id INTEGER PRIMARY KEY, roomId INTEGER, userId INTEGER, MESSAGE text, FOREIGN KEY (roomId) REFERENCES rooms (id)) "
	);
});
